...
Vue.component('create-theme-component', require('./components/CreateThemeComponent.vue').default);
...
Vue.component('blog-component', require('./components/BlogItemComponent.vue').default);
